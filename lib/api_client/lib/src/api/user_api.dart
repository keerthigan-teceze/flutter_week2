...
class UserApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<UsersGet200ResponseInner>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<UsersGet200ResponseInner>>> usersGet({
    ...
    BuiltList<UsersGet200ResponseInner>? _responseData;
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              ...
              specifiedType: const FullType(
                  BuiltList, [FullType(UsersGet200ResponseInner)]),
            ) as BuiltList<UsersGet200ResponseInner>;
    ...
    return Response<BuiltList<UsersGet200ResponseInner>>(
      data: _responseData,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UsersGet200ResponseInner>> usersIdGet({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    UsersGet200ResponseInner? _responseData;
    ...
    return Response<UsersGet200ResponseInner>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [UsersGet200ResponseInner] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UsersGet200ResponseInner>> usersIdPut({
    required String id,
    ...
    try {
      ...
      _bodyData = usersIdPutRequest == null
          ? null
          : _serializers.serialize(usersIdPutRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
