...
class AuthApi {
  ...
  Future<Response<AuthRegisterPost200Response>> authLoginPost({
    ...
    AuthRegisterPost200Response? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(AuthRegisterPost200Response),
            ) as AuthRegisterPost200Response;
    } catch (error, stackTrace) {
      throw DioException(
    ...
    return Response<AuthRegisterPost200Response>(
      data: _responseData,
  ...
  /// Returns a [Future] containing a [Response] with a [AuthRegisterPost200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AuthRegisterPost200Response>> authRefreshPost({
    ...
    try {
      ...
      _bodyData = authRefreshPostRequest == null
          ? null
          : _serializers.serialize(authRefreshPostRequest,
              specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
