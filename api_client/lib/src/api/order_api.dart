...
class OrderApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [OrdersGet200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<OrdersGet200Response>> ordersGet({
    ...
    OrdersGet200Response? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(OrdersGet200Response),
    ...
    return Response<OrdersGet200Response>(
      data: _responseData,
