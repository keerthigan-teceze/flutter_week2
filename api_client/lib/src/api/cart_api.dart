...
class CartApi {
  ...
  Future<Response<CartGet200Response>> cartDelete({
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(CartGet200Response),
            ) as CartGet200Response;
  ...
  /// Returns a [Future] containing a [Response] with a [CartGet200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CartGet200Response>> cartItemsProductIdDelete({
    ...
    final _path = r'/cart/items/{productId}'.replaceAll(
        '{' r'productId' '}',
  ...
  /// Returns a [Future] containing a [Response] with a [CartGet200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CartGet200Response>> cartItemsProductIdPut({
    required String productId,
    CartItemsProductIdPutRequest? cartItemsProductIdPutRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(CartItemsProductIdPutRequest);
      _bodyData = cartItemsProductIdPutRequest == null
          ? null
          : _serializers.serialize(cartItemsProductIdPutRequest,
              specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
